  ...
  const rows = [
    ...
    },
    {
      ...
      className: (val: number) =>
        val < 0 ? "text-red-500 font-medium" : "text-emerald-500 font-medium",
    },
  ];
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-xs text-center whitespace-nowrap">
          <thead className="bg-muted/50 text-muted-foreground">
            <tr>
              <th className="px-3 py-2 font-medium sticky left-0 bg-muted/50">Type</th>
              ...
              <th className="px-2 py-2 font-medium">Sodium</th>
            </tr>
          </thead>
